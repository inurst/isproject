...
@section('page_name2','การค้นคว้าอิสระ')
@section('nav-menu')
                    ...
                    <div class="table-responsive" style="margin-bottom: 20px">
                        <table class="table table-bordered table-framed">
                            ...
                            <tr>
                                ...
                                <td><a href="#" class="alert-link">คลิกเพื่อเข้าสู่การจัดการโครงร่างการค้นคว้าแบบอิสระ</a></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <div class="alert alert-primary alert-bordered">
                        Check list เอกสารประกอบการขอสอบ <a href="#" class="alert-link"><span class="label label-info">คลิกเพื่อเข้าดู</span></a>
                    </div>
                    <div class="table-responsive" style="margin-bottom: 20px">
                        <table class="table table-bordered table-framed">
                            <tbody>
