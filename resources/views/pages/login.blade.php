...
<head>
	...
	<title>ระบบบริหารจัดการโปรเจ็ค</title>
...
<body class="login-container">
	...
	<div class="navbar navbar-inverse bg-indigo">
		<div class="navbar-header">
			<a class="navbar-brand" href="/">The System Support IS</a>
				...
				<form action="index.html">
					<div class="panel panel-body login-form">
						<div class="text-center">
							...
							<h5 class="content-group">เข้าสู่ระบบ<small class="display-block">กรุณากรอกข้อมูล</small></h5>
						</div>
	...
	<div class="footer text-muted text-center">
		&copy; 2017. <a href="#">Department of Computer Science</a> , Chiang Mai University
	</div>
	<!-- /footer -->
